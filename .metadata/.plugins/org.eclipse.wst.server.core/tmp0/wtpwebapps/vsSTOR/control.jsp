				...
				<%
					...
					if (running ==null && split!=null && (force==null) )
					{
					   %>
					   		...
					   		<h4>Split Frequency: <%=split %> seconds</h4>
					   		<br/>
					   		<a href='control.jsp?force=yes'>Change</a>
					   		<br/><br/>
					 		<a href='control?request_type=start' class='btn btn-primary'>Start Streaming</a>
					   		...
					   		<%
					   			if (running != null && running.equals("yes"))
					   			{
					   			   %>
					   			   		...
					   			   		<br/><br/>
					   			   		<a href='control?request_type=stop' class='btn btn-warning' >Stop Streaming</a>
					   			   <%
					   			}
					   		%>
					...
					else
					{
					   %>
					   		...
					   		<form action='control' class='col-md-6' >
					   			<input type=hidden name='request_type' value='set' />
					   			<label>Enter the split frequency (in seconds)</label>
					   			<input type=number name='splittime' placeholder="Split frequence in seconds" required="required" class='form-control' />
					   			<br/>
					   			<input type=submit value='Set Split Frequency' class='btn btn-primary'  />
					   		</form>
