    ...
    <div id="right-panel" class="right-panel">
	  ...
	  <div class="col-sm-6 col-lg-12" >
                <div class="card" style='min-height:600px;'>
					...
					<h4>Here, you can check the health of all the configured nodes across the Distributed System</h4>
					<hr/>
				...
				%>
					...
					<%
						Map<Configuration, String> healthreport = (Map<Configuration, String>) request.getAttribute("healthreport");
						if (healthreport == null || healthreport.size() == 0)
						{
						   %>
						   		<h4>No nodes have been configured yet.</h4>
						   <%
						} else
						{
						   %>
						   		...
						   		<% 
						   			Iterator<Configuration> it = healthreport.keySet().iterator();
						   			while (it.hasNext())
						   			{
						   			   Configuration conf = it.next();
						   			   String health = healthreport.get(conf);
						   			   %>
						   			   		<div class='col-md-3' >
						   			   			
						   			   			<ul class="list-group">
												  <li class="list-group-item"><img src='images/node.png' width=70% /></li>
												  <li class="list-group-item"><%=conf.getHost() %></li>
												  <li class="list-group-item"> 
												  <% if (health.contains("HEALTHY")) { %>
												  		<div style='color: lightgreen;'><i class="menu-icon fa fa-heartbeat"></i> &nbsp;<b><%=health %></b> </div>
												  <% } else { %>
												  		<div style='color: red;'><i class="menu-icon fa fa-chain-broken"></i> &nbsp;<b><%=health %></b></div>
												  <% } %>
												  </li>
												</ul>
